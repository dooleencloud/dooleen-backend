...
@TableName("general_staff_station_byday")
@ApiModel
@ToString(callSuper = true)
public class GeneralStaffStationBydayEntity extends BaseEntity implements Serializable  {
	...
	*/
	 ...
	 * id
	 */
	@DataName(name = "入库日期", isKeyId = true,  isRecordHistory = true)
	@ApiModelProperty(value = "postDate" , position = 0)
	@NotBlank(message = "入库日期")
