...
import com.dooleen.service.file.wps.logic.entity.FileEntity;
...
public interface FileRepository extends BaseRepository<FileEntity, String> {
    ...
    // download_url 不显示到前台
    @Query(value = "select new com.dooleen.service.file.wps.logic.dto.FileListDTO(a.id,a.name,a.version,a.size,b.name,c.name," +
