...
import com.dooleen.service.file.wps.logic.dto.FileReqDTO;
...
public class FileCallBackController extends BaseController {
    ...
    public ResponseEntity<Object> getFileInfo(
        ...
        try {
            Map<String, Object> map = fileService.getFileInfo(_w_userid);
                    //fileService.getFileInfo(_w_userid, _w_filepath, _w_filetype);
            System.out.println("Response.success(map)=="+Response.success(map).toString());
