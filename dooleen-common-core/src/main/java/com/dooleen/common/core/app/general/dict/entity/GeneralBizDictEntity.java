package com.dooleen.common.core.app.general.dict.entity;
 ...
 * @Description : 业务字典管理实体
 * @Author : name
 * @Update : 2020-06-20 16:50:58
 */
@Data
@TableName("general_biz_dict")
@ApiModel
@ToString(callSuper = true)
public class GeneralBizDictEntity extends BaseEntity implements Serializable  {
	...
	*/
	@DataName(name = "字典分类")
	@ApiModelProperty(value = "字典分类", position = 6)
