package com.dooleen.service.biz.question.send.record.entity;
 ...
 * @Description : 问卷下发记录管理实体
 * @Author : name
 * @Update : 2021-02-25 15:53:09
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("biz_question_send_record")
@ApiModel
@ToString(callSuper = true)
public class BizQuestionSendRecordEntity  extends BaseEntity implements Serializable  {
	...
	*/
	...
	@ApiModelProperty(value = "问卷类型", position = 5)
	...
	*/
	...
	@ApiModelProperty(value = "问卷标题", position = 6)
	...
	*/
	...
	@ApiModelProperty(value = "问卷公告", position = 7)
	...
	*/
	...
	@ApiModelProperty(value = "生成频率", position = 9)
	...
	*/
	...
	@ApiModelProperty(value = "生成月", position = 10)
	...
	*/
	...
	@ApiModelProperty(value = "生成日", position = 11)
	...
	*/
	...
	@ApiModelProperty(value = "生成时间", position = 12)
	...
	* 发送时间
	*/
	@DataName(name = "发送时间", isRecordHistory = true)
	...
	*/
	...
	@ApiModelProperty(value = "有效日期", position = 14)
