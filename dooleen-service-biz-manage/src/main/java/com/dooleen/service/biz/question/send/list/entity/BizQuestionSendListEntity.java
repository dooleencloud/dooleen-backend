package com.dooleen.service.biz.question.send.list.entity;
...
public class BizQuestionSendListEntity  extends BaseEntity implements Serializable  {
	...
	*/
	...
	@Length(max=100,message="填报时间长度不能大于100")
	private String fillInDatetime;
	...
	@Length(max=20,message="耗时长度不能大于20")
	...
	@Length(max=100,message="开始时间长度不能大于100")
	...
	@Length(max=5,message="进度比例长度不能大于5")
	@NotBlank(message = "进度比例不能为空")
