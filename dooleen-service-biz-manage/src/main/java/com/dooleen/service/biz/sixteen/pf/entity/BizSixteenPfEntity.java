package com.dooleen.service.biz.sixteen.pf.entity;
 ...
 * @Description : 16PF要素管理实体
 * @Author : name
 * @Update : 2021-05-08 20:29:23
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("biz_sixteen_pf")
@ApiModel
@ToString(callSuper = true)
public class BizSixteenPfEntity  extends BaseEntity implements Serializable  {
	...
	*/
	@Excel(name ="向下分数特征")
	@DataName(name = "向下分数特征", isRecordHistory = true)
	@ApiModelProperty(value = "向下分数特征", position = 6)
	@Length(max=100,message="向下分数特征长度不能大于100")
	...
	*/
	@Excel(name ="向上分数特征")
	@DataName(name = "向上分数特征", isRecordHistory = true)
	@ApiModelProperty(value = "向上分数特征", position = 9)
	@Length(max=100,message="向上分数特征长度不能大于100")
